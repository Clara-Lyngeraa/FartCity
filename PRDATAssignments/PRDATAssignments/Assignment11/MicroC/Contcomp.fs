...
let rec addCST i C =
    ...
    | (a, CSTI b :: EQ :: NOT :: C1) -> if a <> b then addCST 0 C1 else addCST 1 C1
    | (a, CSTI b :: SWAP :: LT :: C1) -> if a > b then addCST 0 C1 else addCST 1 C1
    | (a, CSTI b :: LT :: NOT :: C1) -> if a >= b then addCST 1 C1 else addCST 0 C1
    | _                     -> CSTI i :: C

let addIFZERO lab3 C =
  match C with
  | GOTO lab2 :: Label lab1 :: C1 when lab1 = lab3 -> IFNZRO lab2 :: Label lab1 :: C1
  | _ -> IFZERO lab3 :: C

let addIFNZRO lab3 C =
  match C with
  | GOTO lab2 :: Label lab1 :: C1 when lab1 = lab3 -> IFZERO lab2 :: Label lab1 :: C1
  | _ -> IFNZRO lab3 :: C
